...
query = """
Vou viajar para Lisboa em Setembro de 2024. 
Quero que faça um roteiro de viagem para mim com os os eventos que irão ocorrer na data da viagem e com os preços de passagem de São Paulo para Lisboa
"""
...
def loadData():
    ...
    web_paths=("https://www.dicasdeviagem.com/portugal/",),
...
def getRelevantDocs(query):
    ...
    print(relevant_documents) #aqui
    return relevant_documents


def supervisorAgent(query, llm, webContext, relevant_documents):
    prompt_template = """
    Você é um gerente de uma agencia de viagens. Sua resposta final devera ser um roteiro de viagem completo e detalhado
    Utilize o contexto de eventos e preços de passagens, o input do usuario e também os documentos relevantes para elaborar o roteiro.
    Contexto: {webContext}
